...
\begin{figure}[htp]
	...
	\node [startstop, below of=or, node distance = 2cm, auto] (start) {start handover routine};
...
\appendix
% Appendix for chapter -contagion and more than co-worker
