...
In this study, for locomotion (step-walk), we primarily chose to adopt walking pattern generator (WPG) based on the Linear Inverted Pendulum Mode (LIPM) which was designed and tested in our group~\cite{caron2016humanoids, kajita20013d} along with its native stabilizer~\cite{caron2018stair, kajita2010biped}.
