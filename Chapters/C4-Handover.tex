...
\section{Locomotion and handover \textit{incomplete**}}
...
\textbf{Whole-body control and locomotion:} WBC based handover
...
To the best of our knowledge, none of the previous work considered object handover and locomotion in a single framework using a \textit{biped} humanoid robot such as HRP-2Kai.
...
\section{Preliminary results \textit{incomplete**}}
