...
%\begin{itemize}
%	\item \st{little talk about pose prediction and estimation and interaction forces}
%	\item \st{talk about single hand bi-directional}
%	\item \st{generalization handover}
%	\item \st{two handed handover}
%	\item \st{step-walk ---whole body configuration}
%	\item \st{when to start the motion? -- relative distance -- hysteresis}
%	\item \st{how to meet at handover location ? -- pose estimation}
%\end{itemize}
