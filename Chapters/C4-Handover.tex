...
However, note that in the cases when human co-worker decides to step backward, then the interpersonal distance $ D $ would be larger than 1.2 meters, therefore
