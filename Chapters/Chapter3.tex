...
Motor contagions are implicit effects that cause certain features of an individual's action (like kinematics, goal, or outcome) to become similar to that of the observed action. Studies over the past two decades have reported various motor contagions in human behaviors caused by the observation of other humans as well as robots \cite{Blakemore:NeuroPsyc:2005, Fadiga:JNeuroPhys:1995, Ganesh:Springer:2015, Sciutti:IJSR:2012, Prinz:EJPAP:1997}. Understanding the effects of robots has recently developed pace due to the increased use of robots in co-worker scenarios with humans. In these scenarios, understanding how the behavior of robots affect humans can be beneficial for developing robot behaviors, both to ensure that they are perceived well and do not disturb humans, as well as for modulating human behaviors for the benefit of the task and humans.  
...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{Chapters/c3-plots/setup}}
...
\begin{figure*}[t]
	\includegraphics[width=\textwidth,height=6cm]{Chapters/c3-plots/trialprotocol}
...
\emph{Off-line contagions} on the other hand, are effects induced \emph{after} the observation of actions by another human or robot~\cite{Noy:B&C:2009, Kilner:SocialNeuro:2007, Bisio:PlosOne:2010, Heyes:PB:2011, Ikegami:SciReport:2014, Ikegami:elife:2018}. For example,~\cite{Bisio:PlosOne:2014} measured changes in a participant's hand velocity, with and without an object, after observing the same movement being performed by a human or a humanoid robot. Their result shows that the observation of movement can subsequently affect a participant's hand velocity, both when the observed movements are by a human, or a robot, but again, only when the humanoid robot followed biological laws of motion.
...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{Chapters/c3-plots/offline_result_vel_htp}}	
...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{Chapters/c3-plots/online_result_vel_htp}}	
...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{Chapters/c3-plots/online_result_cong}}
...
\begin{thebibliography}{99}
	...
	\bibitem{Blakemore:NeuroPsyc:2005} S. J. Blakemore, C. Frith, ``The role of motor contagion in the prediction of action.'', {\it Neuropsychologia}, vol. 43, pp. 260-267, 2005.
	
	\bibitem{Fadiga:JNeuroPhys:1995} L. Fadiga, L. Fogassi, G. Pavesi and G. Rizzolatti, ``Motor facilitation during action observation: a magnetic stimulation study.'', {\it Journal of Neurophysiology}, vol 73, pp. 2608-2611, 1995.
	
	\bibitem{Ganesh:Springer:2015} G. Ganesh, T. Ikegami, ``Beyond watching: Action understanding by humans and implications for motion planning by interacting robots.'', {\it Springer Tracts in Advanced Robotics (Springer Verlag)}, vol. 111, pp. 139-167, 2015.
	
	\bibitem{Sciutti:IJSR:2012} A. Sciutti, A. Bisio, F. Nori, G. Metta, L. Fadiga, T. Pozzo, G. Sandini, ``Measuring human-robot interaction through motor resonance.'', {\it International Journal of Social Robotics}, vol. 4, no. 3, pp. 223-234, 2012.
	
	\bibitem{Prinz:EJPAP:1997} W. Prinz, ``Perception and Action Planning.'' {\it European Journal of Perception and Action Planning}, vol. 9, 129-154, 1997.
	
	\bibitem{Kupferberg:Methods:2009} A. Kupferberg, S. Glasauer, M. Huber, M. Rickert, A. Knoll, ``Video observation of humanoid robot movements elicits motor interference.'', {\it Methods}, pp. 2-6, 2009.
	
	\bibitem{Oztop:RAS_ICHR:2004} E. Oztop, T. Chaminade and D. W. Franklin, ``Human-humanoid interaction: is a humanoid robot perceived as a human?'', {\it 4th IEEE/RAS International Conference on Humanoid Robots}, Santa Monica, CA, USA, pp. 830-841, 2004.
	
	\bibitem{Chaminade:JPP:2009} T. Chaminade, G. Cheng, ``Social cognitive neuroscience and humanoid robotics.'', {\it Journal of Physiology Paris}, vol. 103, pp. 286-295, 2009.
	
	\bibitem{Kupferberg:PlosOne:2012}A. Kupferberg, M. Huber, B. Helfer, C. Lenz, S. Glasauer, ``Moving just like you: Motor interference depends on similar motility of agent and observer.'', {\it PLoS ONE}. vol. 7, no. 6, pp. e39637, 2012.
	
	\bibitem{Brass:ActaPsych:2001} M. Brass, H. Bekkering, W. Prinz, ``Movement observation affects movement execution in a simple response task.'', {\it Acta Psychologica}, vol. 106, pp. 3-22, 2001.
	
	\bibitem{Press:CBR:2005} Press, G. Bird, R. Flach, C. Heyes, ``Robotic movement elicits automatic imitation.'', {\it Cognitive Brain Research}, vol. 25, pp. 632-640, 2005.
	
	\bibitem{Kilner:CurBio:2003} J. M. Kilner, Y. Paulignan, S. J. Blakemore, ``An interference effect of observed biological movement on action.'', {\it Current Biology}, vol. 13, pp. 522-525, 2003.
	
	\bibitem{Noy:B&C:2009} L. Noy, R. I. Rumiati, T. Flash, ``Simple movement imitation: Are kinematic features sufficient to map perceptions into actions.'', {\it Brain and Cognition}, vol. 69, pp. 360-368, 2009.
	
	\bibitem{Kilner:SocialNeuro:2007} J. Kilner, A. F. Hamilton, S. J. Blakemore, ``Interference effect of observed human movement on action is due to velocity profile of biological motion.'', {\it Social Neuroscience}, vol. 2, pp. 158-166, 2007.
	
	\bibitem{Bisio:PlosOne:2010} A. Bisio, N. Stucchi, M. Jacono, L. Fadiga, T. Pozzo, ``Automatic versus voluntary motor imitation: Effect of visual context and stimulus velocity.'', {\it PLoS ONE}, vol. 15, pp.1-8, 2010.
	
	\bibitem{Heyes:PB:2011} C. Heyes, ``Automatic imitation.'', {\it Psychological Bulletin}, vol. 137, no. 3, pp. 463-483, 2011.
	
	\bibitem{Ikegami:SciReport:2014} T. Ikegami, G. Ganesh, ``Watching novice action degrades expert motor performance: Causation between action production and outcome prediction of observed actions by humans.'', {\it Scientific Reports}, vol. 4, pp. 6989, 2014.
	
	\bibitem{Ikegami:elife:2018} T. Ikegami, G. Ganesh, T. Takeuchi, H. Nakamoto, ``Prediction error induced motor contagions in human behaviors.'', \textit{Elife} 2018;7:e33392 DOI: 10.7554/ELIFE.33392.
	
	\bibitem{Bisio:PlosOne:2014} A. Bisio, A. Sciutti, F. Nori, G. Metta, L. Fadiga, G. Sandini, T. Pozzo, ``Motor contagion during human-human and human-robot interaction.'', {\it PLoS ONE}, vol. 9, pp. 1-10, 2014.
	
	\bibitem{Kaneko:RAS_ICHR:2015} K. Kaneko, M. Morisawa, S. Kajita, S. Nakaoka, T. Sakaguchi, R. Cisneros, F. Kanehiro, ``Humanoid robot HRP-2Kai - Improvement of HRP-2 towards disaster response tasks.'', {\it IEEE-RAS International Conference on Humanoid Robots, (IEEE Computer Society)}, pp. 132-139, 2015.
	
	\bibitem{Biagiotti:Springer:2008} L. Biagiotti, C. Melchiorri. {\it Trajectory planning for automatic machines and robots}. Berlin Heidelberg: Springer, 2008.
	
	\bibitem{Erdfelder:JBRMIC:1996} E. Erdfelder, F. Faul and A. Buchner, ``GPOWER: A general power analysis program.", {\it Journal of Behavior research methods, instruments, \& computers, Springer}, vol. 28, no. 1, pp. 1-11, 1996.
	
	\bibitem{Verma:power_analysis:2017} J. P. Verma and P. Verma, ``Determination of Sample Size and Power Analysis with G*Power Software: Step-wise Illustrated Manual for Research Scholars.", {\it Independently published on Amazon}, pp. 31-32, 2017.
	
	\bibitem{Akaike:ISIT:1973} H. Akaike, ``Information theory and an extensi{\'o}n of the maximum likelihood principle.'', {\it Proceedings of the 2nd International Symposium on Information Theory}, pp. 267-281, 1973.
