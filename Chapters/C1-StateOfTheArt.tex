...
plosone::\textbf{Our results show that human task frequency, but not task accuracy, is affected by the observation of a humanoid robot co-worker, provided the robot's head and torso are visible.
}
...
%Proactive approaches in pHRI


\subsection{Proactive robot handover behaviors}
