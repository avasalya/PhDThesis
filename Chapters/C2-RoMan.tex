...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{plots/c2-plots/offline_result_vel_htp}}	
...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{plots/c2-plots/online_result_vel_htp}}	
...
\begin{figure}[t]
	\centering{\includegraphics[width=1\columnwidth]{plots/c2-plots/online_result_cong}}
...
%\st{In the Subsection~\nameref{motor contagion} of Chapter~\ref{sota}}
